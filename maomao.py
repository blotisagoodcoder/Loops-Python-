...
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("cat.png"),
...
while running:
    ...
    if not won:
        ...
        x_change = (keys[pygame.K_RIGHT] -keys[pygame.L_LEFT]) * MOVEMENT_SPEED
        y_change = (keys[pygame.K_DOWN] - keys)
